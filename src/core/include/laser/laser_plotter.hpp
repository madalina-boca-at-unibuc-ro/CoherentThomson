...
// Exports a heat map of the field intensity (Ex^2+Ey^2+Ez^2) over an x/y grid at z=0 and a fixed time
// t. x_min/x_max/y_min/y_max are given in the same atomic units as
